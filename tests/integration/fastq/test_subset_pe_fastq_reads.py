...
class TestSubsetPEFastQReads(object):
    ...
    def test_subset_pe_fastq_reads(self, mocked_print):
        input_file_1 = f"{here.parent.parent.parent}/sample_files/DRR284700_1_subset.fastq"
        input_file_2 = f"{here.parent.parent.parent}/sample_files/DRR284700_2_subset.fastq"
        ...
        with open(f"{here.parent.parent}/expected/DRR284700_1_subset_subset.fq", "r") as expected_fq_1, open(
