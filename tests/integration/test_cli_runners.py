...
#     def test_bk_gene_wise_relative_synonymous_codon_usage(self):
#         cmd = "bk_gene_wise_relative_synonymous_codon_usage -h"
#         exit_status = os.system(cmd)
#         assert exit_status == 0

#     def test_bk_gene_wise_rscu(self):
#         cmd = "bk_gene_wise_rscu -h"
#         exit_status = os.system(cmd)
#         assert exit_status == 0

#     def test_bk_gw_rscu(self):
#         cmd = "bk_gw_rscu -h"
#         exit_status = os.system(cmd)
#         assert exit_status == 0
...
#     def test_bk_remove_fasta_entry(self):
#         cmd = "bk_remove_fasta_entry -h"
#         exit_status = os.system(cmd)
#         assert exit_status == 0

#     def test_bk_remove_short_sequences(self):
#         cmd = "bk_remove_short_sequences -h"
#         exit_status = os.system(cmd)
#         assert exit_status == 0

#     def test_bk_remove_short_seqs(self):
#         cmd = "bk_remove_short_seqs -h"
#         exit_status = os.system(cmd)
#         assert exit_status == 0
