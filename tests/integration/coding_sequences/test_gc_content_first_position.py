...
class TestAlignmentSummary(object):
    ...
    def test_gc_content_first_position_invalid_input(self, mocked_print):  # noqa
    ...
    @patch("builtins.print")
    def test_gc_content_first_position_simple_verbose(self, mocked_print):
    ...
    @patch("builtins.print")
    def test_gc_content_first_position_simple_verbose_alias(self, mocked_print):
        expected_result_0 = textwrap.dedent(
            """lcl|NC_001133.9_cds_NP_009332.1_1\t0.4876"""
        )
        expected_result_1 = textwrap.dedent(
