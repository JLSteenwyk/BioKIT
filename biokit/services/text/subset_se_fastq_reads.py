...
class SubsetSEFastQReads(Text):
    ...
    def run(self):
        ...
        number_of_reads_to_subsample = self.proper_round(number_of_total_reads*self.percent)
        random.seed(self.seed)
        random_list = random.sample(range(0, number_of_total_reads), number_of_reads_to_subsample)
